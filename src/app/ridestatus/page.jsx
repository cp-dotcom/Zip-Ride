...
//           ))}
//         </div>
//         <div className="bg-[#FEF9E2] rounded-2xl mt-5 p-3 w-full text-sm text-black">{t("driverArriving.cancelRide.policy")}</div>
//         <div className="flex gap-3 mt-6 w-full">
//           <button onClick={onClose} className="flex-1 py-3 rounded-xl bg-[#f7e6a3] shadow font-bold">
//             {t("driverArriving.cancelRide.keepRide")}
//           </button>
//           <button onClick={onClose} className="flex-1 py-3 rounded-xl bg-[#edd875] shadow font-bold">
