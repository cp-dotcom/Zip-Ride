...
//             {/* Confirm Button */}
//             <Link  href="/vehiclemanagement" className="bg-[#F6E7B4] hover:bg-[#e3d69f] text-gray-800 font-semibold rounded-full px-8 py-3 shadow-lg mt-8 flex items-center justify-center transition-all duration-200">
//               Select Vehicle
...
import BackButton from "../components/bookRide/BackButton";
import RideForm from "../components/bookRide/RideForm";
